...
namespace FluGASv25.Dao.CreateSQL
{
    public static class DbCreate
    {
        ...
        {
             "FluGASv25.Dao.CreateSQL.CreateSequencer.txt",
             "FluGASv25.Dao.CreateSQL.CreateTableMinionParams.txt",
             "FluGASv25.Dao.CreateSQL.CreateTableMiseqParams.txt",
             "FluGASv25.Dao.CreateSQL.CreateTableSample.txt",
             "FluGASv25.Dao.CreateSQL.CreateTableReference.txt",
             "FluGASv25.Dao.CreateSQL.CreateTableGISAID.txt",
        };
        ...
        public static bool CheckDb(string[] tables, ref string message)
        {
            ...
            try
            {
                if (File.Exists(sqliteFile))
                    Dao.MiseqParameterDao.GetParameters(); // throwable exception
                else
